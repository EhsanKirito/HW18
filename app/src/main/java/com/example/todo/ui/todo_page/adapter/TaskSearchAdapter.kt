...
class TaskSearchAdapter(
    ...
    ListAdapter<Task, TaskSearchAdapter.TaskViewHolder>(TaskDiffCallback) {

    class TaskViewHolder(itemView: View) :
        RecyclerView.ViewHolder(itemView) {
        private val itemHost: ConstraintLayout = itemView.findViewById(R.id.constraint_layout)
        ...
        private fun bindBackground(task: Task) {
